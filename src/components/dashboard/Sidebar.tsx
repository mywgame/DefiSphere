        ...
        <>
            ...
            >
                <div className="flex h-16 items-center justify-between px-5">
                    {/* Updated Custom Code-Based Logo to match image */}
                    <Link to="/" className="flex items-center gap-2">
                        {/* Delta Icon Container with Blue-Purple Gradient */}
                        ...
                        {/* Logo Text Styled to match exact branding */}
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-white/5 bg-gradient-to-br from-[color:var(--neon-purple)]/15 to-[color:var(--neon-cyan)]/10 p-4">
                    <div className="flex items-center gap-2">
                        <Gift className="h-4 w-4 text-[color:var(--neon-cyan)]" />
                        <p className="text-xs font-semibold">Refer & earn 8%</p>
                    </div>
